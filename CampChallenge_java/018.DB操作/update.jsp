...
//    n = new String(n.getBytes("ISO_8859_1"), "UTF-8");
    ...
    out.println(n+"<br>");
    //中略 
    db_st = db_con.prepareStatement("update profiles set profilesID=? , name=? ,tel=? ,age=? ,birthday=?  where profilesID = ?");
    ...
    db_st.setString(5,request.getParameter("birthday").toString());
     db_st.setString(6,request.getParameter("profilesID").toString());
