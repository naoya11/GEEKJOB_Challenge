...
//    out.println(n+"<br>");
    ...
    db_st.setString(1,request.getParameter("name").toString());
    db_st.setString(2,request.getParameter("age").toString());
    db_st.setString(3,request.getParameter("birthday").toString());
